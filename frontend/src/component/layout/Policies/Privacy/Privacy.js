  ...
  return (
    <div className="para">
      ...
      <p>
        ...
        of your information, at any time, by contacting us at info@fabtokru.com
      ...
      <p>
        ...
        you. Your data is stored through Shopify’s data storage, databases and
        the general Shopify application. They store your data on a secure server
        behind a firewall.
      </p>
      <h4>Payment</h4>
      <p>
      ...
      <p>
        ...
        <br />
        <br />
        _shopify_uniq, no data held, expires midnight (relative to the visitor)
        of the next day, Counts the number of visits to a store by a single
        customer.
        <br />
        <br />
        ...
        <br />
        <br />
        PREF, persistent for a very short period, Set by Google and tracks who
        visits the store and from where
      </p>
      ...
      <p>
        ...
        information contact our Privacy Compliance Officer at info@fabtokri.com
